...
export const defaults = {
  ...
  requesty_apikey: process.env.NEXT_PUBLIC_REQUESTY_APIKEY ?? '',
  requesty_url: process.env.NEXT_PUBLIC_REQUESTY_URL ?? 'https://router.requesty.ai/v1',
  requesty_model: process.env.NEXT_PUBLIC_REQUESTY_MODEL ?? 'openai/gpt-4o-mini',
  tts_muted: 'false',
