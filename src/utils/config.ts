...
export const defaults = {
  ...
  minimax_apikey: process.env.NEXT_PUBLIC_MINIMAX_APIKEY ?? '',
  minimax_url: process.env.NEXT_PUBLIC_MINIMAX_URL ?? 'https://api.minimax.io/v1',
  minimax_model: process.env.NEXT_PUBLIC_MINIMAX_MODEL ?? 'MiniMax-M2.7',
  tts_muted: 'false',
