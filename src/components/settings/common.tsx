...
export function getIconFromPage(page: string): JSX.Element {
  switch(page) {
    ...
    case 'minimax_settings':    return <AdjustmentsHorizontalIcon className="h-5 w-5 flex-none text-gray-800" aria-hidden="true" />;
...
function getLabelFromPage(page: string): string {
  ...
  switch(page) {
    ...
    case 'minimax_settings':    return t('MiniMax');
