...
// Define file paths
const configFilePath = path.resolve('src/features/externalAPI/dataHandlerStorage/config.json');
const subconsciousFilePath = path.resolve('src/features/externalAPI/dataHandlerStorage/subconscious.json');
const logsFilePath = path.resolve('src/features/externalAPI/dataHandlerStorage/logs.json');
const userInputMessagesFilePath = path.resolve('src/features/externalAPI/dataHandlerStorage/userInputMessages.json');
